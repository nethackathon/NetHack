...
CONTAINER("sack",           "bag", 0, 0, 0, 35,  15,   2, CLOTH, HI_CLOTH,
                                                                SACK),
CONTAINER("bag of bags",    "bag", 0, 0, 0, 35,  15,   2, CLOTH, HI_CLOTH,
                                                                BAG_OF_BAGS),
CONTAINER("Gucci handbag",  "fancy bag", 0, 0, 0, 35,  15,   2000, CLOTH, HI_CLOTH,
                                                                DESIGNER_BAG),
CONTAINER("Faberge egg",    "jeweled egg", 0, 0, 0, 1,  15,   10000, GLASS, HI_GLASS,
                                                                FABERGE_EGG),
