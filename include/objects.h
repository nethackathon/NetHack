...
CONTAINER("sack",           "bag", 0, 0, 0, 35,  15,   2, CLOTH, HI_CLOTH,
                                                                SACK),
CONTAINER("Faberge egg",    NoDes, 0, 0, 0, 1,  15,   10000, GLASS, HI_GLASS,
                                                                FABERGE_EGG),
...
FOOD("egg",                  85,  1,  1, 1, FLESH,  80, CLR_WHITE,
                                                        EGG),
FOOD("black dyed egg",                  7,  1,  1, 1, FLESH,  80, CLR_BLACK,
                                                        BLACK_EGG),
FOOD("blue dyed egg",                  7,  1,  1, 1, FLESH,  80, CLR_BLUE,
                                                        BLUE_EGG),
FOOD("bright blue dyed egg",                  7,  1,  1, 1, FLESH,  80, CLR_BRIGHT_BLUE,
                                                        B_BLUE_EGG),
FOOD("red dyed egg",                  7,  1,  1, 1, FLESH,  80, CLR_RED,
                                                        RED_EGG),
FOOD("pink dyed egg",                  7,  1,  1, 1, FLESH,  80, CLR_MAGENTA,
                                                        PINK_EGG),
FOOD("orange dyed egg",                  7,  1,  1, 1, FLESH,  80, CLR_ORANGE,
                                                        ORANGE_EGG),
FOOD("bright pink dyed egg",                  7,  1,  1, 1, FLESH,  80, CLR_BRIGHT_MAGENTA,
                                                        B_PINK_EGG),
FOOD("green dyed egg",                  7,  1,  1, 1, FLESH,  80, CLR_GREEN,
                                                        GREEN_EGG),
FOOD("blue-green dyed egg",                  7,  1,  1, 1, FLESH,  80, CLR_CYAN,
                                                        BLUE_GREEN_EGG),
FOOD("bright green dyed egg",                  7,  1,  1, 1, FLESH,  80, CLR_BRIGHT_GREEN,
                                                        B_GREEN_EGG),
FOOD("bright blue-green dyed egg",                  7,  1,  1, 1, FLESH,  80, CLR_BRIGHT_CYAN,
                                                        B_BLUE_GREEN_EGG),
FOOD("brown dyed egg",                  7,  1,  1, 1, FLESH,  80, CLR_BROWN,
                                                        BROWN_EGG),
FOOD("gray dyed egg",                  7,  1,  1, 1, FLESH,  80, CLR_GRAY,
                                                        GRAY_EGG),
FOOD("yellow dyed egg",                  7,  1,  1, 1, FLESH,  80, CLR_YELLOW,
                                                        YELLOW_EGG),
...
FOOD("fortune cookie",       55,  1,  1, 0, VEGGY,  40, CLR_YELLOW,
                                                              FORTUNE_COOKIE),
FOOD("chocolate egg",       7,  1,  1, 0, VEGGY,  40, CLR_BROWN,
                                                              CHOCOLATE_EGG),
...
ROCK("rock", NoDes,         1, 100,  10,  0, 3, 3, 0, 10, 7, MINERAL, CLR_GRAY,
                                                                    ROCK),
ROCK("golden egg", NoDes,   1, 3,  75,  7500, 10, 10, 1, 10, 7, METAL, HI_GOLD,
                                                                    GOLDEN_EGG),
#undef GEM
#undef ROCK
