 ...
 */
    ...
    MON("gargoyle", S_GREMLIN, LVL(6, 10, -4, 0, -9), (G_GENO | 2),
        ...
        M1_HUMANOID | M1_THICK_HIDE | M1_BREATHLESS, M2_HOSTILE | M2_STRONG | M2_IS_STONE,
    ...
    MON("winged gargoyle", S_GREMLIN, LVL(9, 15, -2, 0, -12), (G_GENO | 1),
        ...
        M2_LORD | M2_HOSTILE | M2_STRONG | M2_MAGIC | M2_IS_STONE, 0, 11, HI_LORD,
        WINGED_GARGOYLE),
    /*
     * humanoids
     */
    ...
    MON("earth elemental", S_ELEMENTAL, LVL(8, 6, 2, 30, 0), (G_NOCORPSE | 1),
        ...
        M2_STRONG | M2_NEUTER | M2_IS_STONE, 0, 10, CLR_BROWN, EARTH_ELEMENTAL),
    ...
    MON("xorn", S_XORN, LVL(8, 9, -2, 20, 0), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_STRONG | M2_IS_STONE, 0, 11, CLR_BROWN, XORN),
    /*
     * Apelike beasts
     */
    ...
    MON("stone golem", S_GOLEM, LVL(14, 6, 5, 50, 0), (G_NOCORPSE | 1),
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE,
        M2_HOSTILE | M2_STRONG | M2_IS_STONE, 0, 15, CLR_GRAY, STONE_GOLEM),
